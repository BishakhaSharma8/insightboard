  ...
  return (
    <>
      ...
      <div style={styles.container}>
        ...
        <p style={styles.text}>
          👋 Hello! I'm <strong>Bishakha Sharma</strong>, a highly motivated <strong>Java Developer</strong> and <strong>MERN Stack Developer</strong> with a passion for building scalable and user-centric web applications.
        </p>
        <p style={styles.text}>
